...
historical_figures = {
    'Лев Толстой': ['Автор романа "Война и мир"', 'https://avatars.mds.yandex.net/get-entity_search/2487574/1153009192/S600xU_2x'],
    'Наполеон Бонапарт': ['Император Франции, прославившийся завоеваниями в Европе', 'https://i.pinimg.com/originals/d6/3d/ee/d63dee146b067e50a7a86ec7a1b73fd4.png'],
    'Иван Грозный': ['Первый русский царь, который провел реформы и расширил территорию России', 'https://avatars.dzeninfra.ru/get-zen_doc/1586459/pub_5fcf9b550a45a91cf4df3626_5fcfa0489d0fbc29ba78e8a0/scale_1200'],
    'Альберт Эйнштейн': ['Создатель теории относительности', 'https://infocz-media.s3.amazonaws.com/infocz/production/files/2020/07/22/18/02/56/1feeaac4-93a7-48dd-be74-d79a6b1f8b82/5024396.jpg'],
    'Христофор Колумб': ['Мореплаватель, открывший Новый Свет (Америку)', 'https://cdn1.img.sputnikglobe.com/img/107813/13/1078131332_0:34:2643:2016_1920x0_80_0_0_a12d6d0c3b6603f74c502506b3481f1f.jpg'],
    'Чарльз Дарвин': ['Учёный, пришедший к выводу о том, что все виды живых организмов эволюционируют со временем', 'https://upload.wikimedia.org/wikipedia/commons/thumb/2/2e/Charles_Darwin_seated_crop.jpg/800px-Charles_Darwin_seated_crop.jpg'],
    'Джеймс Уатт': ['Инженер, изобретатель, ввёл первую единицу мощности — лошадиную силу. Создал универсальную паровую машину двойного действия.', 'https://i.pinimg.com/736x/61/19/23/611923d2c7744b6aaaa670a318b90c7e.jpg'],
    'Мартин Лютер': ['Немецкий христианский богослов, инициатор Реформации. Ключевой создатель протестантизма ', 'https://i.pinimg.com/originals/2f/90/9c/2f909cce6eb54590ffcfa7b5f0df9981.jpg'],
    'Джордж Вашингтон': ['Первый президент Соединённых Штатов Америки, один из отцов-основателей США', 'https://www.mindonmap.com/wp-content/uploads/2025/01/george-washington-image.jpg'],
    'Вильгельм Рентген': ['Физик, первый лауреат Нобелевской премии, изобретатель рентгена', 'https://avatars.dzeninfra.ru/get-zen_doc/271828/pub_65e5aba6b085f22775903c49_65e5b40b5929c940c2920073/scale_1200'],
    'Пётр Великий': ['Первый российский император, развернул масштабные реформы российского государства', 'https://stihi.ru/pics/2022/05/28/4005.jpg'],
    'Илон Маск': ['Основатель и гендиректор SpaceX, самый богатый человек в мире на февраль 2025 года', 'https://avatars.mds.yandex.net/get-entity_search/2028178/1133028844/S600xU_2x']
}
...
def handle_start(message):
    ...
    sp = historical_figures[current_person]
    try:
        bot.send_photo(message.chat.id, sp[1])
        bot.send_message(message.chat.id, f"{sp[0]} \n\nНапишите имя и фамилию/прозвище")
    except:
        bot.send_message(message.chat.id, f"{sp[0]} \n\nНапишите имя и фамилию/прозвище")
